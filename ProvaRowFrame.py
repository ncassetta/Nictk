...
rfr1.config_children(relief="solid", bcolor = "blue", fcolor="yellow")
rfr1.add_row(30)
rfr1.add_row("30%")
rfr1.add_row("30%")
rfr1.add_row("30%")
...
lab2 = NCtkLabel(rfr1, "pack", "20%", "50%", "fill", pad=(10, 0), content="This is a fixed size row")
rfr1.set_active(1)
lab3 = NCtkLabel(rfr1, "pack", "20%", "30%", "60%", pad=(10, 0), content="A label in row 1")
lab4 = NCtkLabel(rfr1, "pack", "20%", "50%", "60%", pad=(10, 0), content="This is a 30% size row")
rfr1.set_active(2)
lab5 = NCtkLabel(rfr1, "pack", "20%", "30%", "60%", pad=(10, 0), content="A label in row 2")
lab6 = NCtkLabel(rfr1, "pack", "20%", "50%", "60%", pad=(10, 0), content="This is a 30% size row")
