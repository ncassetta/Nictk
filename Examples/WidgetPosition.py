...
winMain.config_children(Ntk.NtkLabel, relief=Ntk.RIDGE, font=("Arial", 10))

# create the children
lab1 = Ntk.NtkLabel(winMain, 0, 0, 600, 50, pad=(10, 5), content=STR_LAB1)
lab1.config(bcolor="#A0B0C0")

lab2 = Ntk.NtkLabel(winMain, 0, Ntk.PACK, "75%", 50, pad=(10, 5), content=STR_LAB2)
lab2.config(bcolor="#F0F080")

lab3 = Ntk.NtkLabel(winMain, 0, Ntk.PACK, -200, "10%", pad=(10, 5), content=STR_LAB3)
lab3.config(bcolor="#C090E0")

hfr1 = Ntk.NtkHorFrame(winMain, 0, Ntk.PACK, Ntk.FILL, 180, content=STR_HOR1)
hfr1.config(bcolor="#C0C070")

lab4 = Ntk.NtkLabel(hfr1, "10%", Ntk.CENTER, "40%", 80, pad=(5,0), content=STR_LAB4)
lab4.config(bcolor="#E07080")

lab5 = Ntk.NtkLabel(hfr1, Ntk.PACK, Ntk.CENTER, "40%", 80, pad=(5, 0), content=STR_LAB5)
lab5.config(bcolor="#20F0C0")

lab6 = Ntk.NtkLabel(winMain, -600, Ntk.PACK, -100, 60, pad=(0, 10), content=STR_LAB6)
lab6.config(bcolor="#70F060")

lab7 = Ntk.NtkLabel(winMain, 0, -70, Ntk.FILL, 60, pad=10, content=
                    "Try to resize the window horizontally or vertically")
lab7.config(bcolor="#6090F0", anchor=Ntk.CENTER)
