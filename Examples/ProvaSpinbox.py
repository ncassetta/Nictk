...
rfr1.add_row(40)
spb1 = NCtkSpinbox(rfr1, CENTER, 0, "50%", FILL, pad=(0, 5), limits=CITTA, command=changelabel)
...
radMode1 = NCtkRadiobutton(vfrMode, 0, PACK, FILL, "33%", pad=(10, 0, 5, 0), command=changemode)
radMode1.config(variable=optMode, value=tempT[0], text=tempT[0])
radMode2 = NCtkRadiobutton(vfrMode, 0, PACK, FILL, "33%", pad=(10, 0, 5, 0), command=changemode)
radMode2.config(variable=optMode, value= tempT[1], text=tempT[1])
radMode3 = NCtkRadiobutton(vfrMode, 0, PACK, FILL, "33%", pad=(10, 0, 5, 0), command=changemode)
...
radWrap1 = NCtkRadiobutton(vfrWrap, 0, PACK, FILL, "33%", pad=(10, 0, 5, 0), command=changewrap)
radWrap1.config(variable=optWrap, value=True, text="True")
radWrap2 = NCtkRadiobutton(vfrWrap, 0, PACK, FILL, "33%", pad=(10, 0, 5, 0), command=changewrap)
...
rfr2.config(bcolor="green", text="Spinbox2", relief=RIDGE)
rfr2.add_row(40)
spb2 = NCtkSpinbox(rfr2, 0, 0, 150, FILL, limits=(1.0, 10.0, 0.5), command=changelabel)
