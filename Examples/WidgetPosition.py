...
winMain = Ntk.Main(50, 50, 800, 600, "Ntk widget positioning example")
# set the font for all children
winMain.config_children(Ntk.Label, relief=RIDGE, font=("Arial", 10))

# create the children
lab1 = Ntk.Label(winMain, 0, 0, 600, 50, pad=(10, 5), content=STR_LAB1)
lab1.config(bcolor="#A0B0C0")

lab2 = Ntk.Label(winMain, 0, PACK, "75%", 50, pad=(10, 5), content=STR_LAB2)
lab2.config(bcolor="#F0F080")

lab3 = Ntk.Label(winMain, 0, PACK, -200, "10%", pad=(10, 5), content=STR_LAB3)
lab3.config(bcolor="#C090E0")

hfr1 = Ntk.HorFrame(winMain, 0, PACK, FILL, 180, content=STR_HOR1)
hfr1.config(bcolor="#C0C070")

lab4 = Ntk.Label(hfr1, "10%", CENTER, "40%", 80, pad=(5,0), content=STR_LAB4)
lab4.config(bcolor="#E07080")

lab5 = Ntk.Label(hfr1, PACK, CENTER, "40%", 80, pad=(5, 0), content=STR_LAB5)
lab5.config(bcolor="#20F0C0")

lab6 = Ntk.Label(winMain, -600, PACK, -100, 60, pad=(0, 10), content=STR_LAB6)
lab6.config(bcolor="#70F060")

lab7 = Ntk.Label(winMain, 0, -70, FILL, 60, pad=10, content=
